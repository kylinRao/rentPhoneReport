...
UPDATE rentLog set returnName='饶麒麟',returnPhone='18551789470',status=0,returntime=(datetime(CURRENT_TIMESTAMP,'localtime'),battaryLevel='getNobattaryLevel',gameboxVersion='getNogameboxVersion',hiappVersion='getNohiappVersion',hmsVersion='getNohmsVersion')
;